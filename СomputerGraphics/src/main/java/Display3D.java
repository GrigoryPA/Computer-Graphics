...
public class Display3D {
    ...
    public Display3D(int _widthVirtualDisplay, int _heightVirtualDisplay, Color[][] color) {
        widthVirtualDisplay = _widthVirtualDisplay;
        heightVirtualDisplay = _heightVirtualDisplay;
        display = color;
        return;
    }

    public Display3D(ScreenData screen) {
        widthVirtualDisplay = screen.width;
        heightVirtualDisplay = screen.height;
        display = screen.pointsColor;
        return;
    }
